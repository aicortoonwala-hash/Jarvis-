...
class MainActivity : ComponentActivity() {
    ...
    private fun startVoiceService() {
        ...
        } catch (_: Exception) { setStatus("Hands-free could not start. Check microphone and notification permissions.") }
    }
    ...
    private fun isWeatherCommand(command: String): Boolean {
        val c = command.lowercase(); return c.contains("weather") || c.contains("temperature") || c.contains("mausam") || c.contains("taapman")
    }
